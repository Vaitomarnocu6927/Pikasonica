function onCreate()
	-- background shit
	makeLuaSprite('stagechu', 'stagechu', -500, -300);
	setLuaSpriteScrollFactor('stagechu', 0.9, 0.9);
  ...
  makeLuaSprite('borderchu', 'borderchu', 0, 0);

 setObjectCamera('borderchu', 'hud');
	
	addLuaSprite('borderchu', true);
